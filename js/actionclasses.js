...
function TermCommand(slide, data) {
    var data = data;
    var termcontroller = data['termcontroller'];
	...
	termcontroller.writeCommand(command);
    }

    this.reverse = function() {
	termcontroller.reverse();
    }

    this.finish = function() {
	termcontroller.finish();
    }

    this.toData = function() {
	return {'action': 'termcommand', 'id': data['id'], 'command': data['command']};
    }
}

function TermEnter(slide, data) {
    var data = data;
    var termcontroller = data['termcontroller'];
    ...
    this.toData = function() {
	return {'action': 'termenter', 'cid': data['cid']};
    }
}
